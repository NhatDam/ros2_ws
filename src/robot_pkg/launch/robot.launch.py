...
def generate_launch_description():
  ...
  default_urdf_model_path = os.path.join(pkg_share, 'urdf/Model.urdf.xacro')
  robotDescription = xacro.process_file(default_urdf_model_path).toxml()
  
  #this is the absolute path to the world model
  pathWorldFile = os.path.join(pkg_share,'worlds/hello.world')
